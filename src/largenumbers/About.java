...
public class About extends javax.swing.JFrame {
    ...
    public About() {
        initComponents();
        this.setTitle("About LargeNumbers");
        
        try {
            urlWiki = new URI("http://en.wikipedia.org/wiki/Law_of_large_numbers");
            urlRepo = new URI("https://github.com/GiacomoPinardi/LargeNumbers");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Large Numbers");

        jLabel2.setFont(new java.awt.Font("Dialog", 3, 12)); // NOI18N
        jLabel2.setText("Description:");

        appDescLabel.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        appDescLabel.setText("<html>A Java desktop application based on Swing Application Framework. This application allow you to watch the operation of one of the biggest mathematical law.</html>");
        ...
        jLabel9.setText("<html>Law of Large Numbers (on Wikipedia):<html>");
